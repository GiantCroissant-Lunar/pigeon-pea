...
**Solution:** PluginLoadContext checks assembly names and returns `null` for shared contracts, forcing .NET to use Default ALC's version:
...
- **[GOAP Perception Checklist](./goap-perception-checklist.md)** - AI system integration
- **[Observable Collections](./observable-collections.md)** - Reactive patterns for UI and data
