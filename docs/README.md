...
- **[GITHUB_ISSUES.md](planning/GITHUB_ISSUES.md)**: Breakdown of all RFCs into 43 actionable GitHub issues
...
2. Use [GITHUB_ISSUES.md](planning/GITHUB_ISSUES.md) to break down RFCs into actionable tasks
