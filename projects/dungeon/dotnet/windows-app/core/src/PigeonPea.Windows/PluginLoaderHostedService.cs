...
/// <summary>
/// Hosted service that discovers and loads plugins on application startup for the Windows app.
/// This lives in the Windows app so that the core plugin system library
/// does not depend on Microsoft.Extensions.Hosting.
/// </summary>
public sealed class PluginLoaderHostedService : IHostedService
{
