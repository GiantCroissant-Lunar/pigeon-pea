...
public class SixelRenderer : IRenderer
{
    ...
    public SixelRenderer(ILogger logger)
    {
        _logger = logger;
    }

    public string Id => "sixel-terminal-renderer";

    public RenderingCapabilities Capabilities => RenderingCapabilities.Sixel;
    ...
    public void Initialize(RenderContext context)
    {
        ...
        _logger.LogInformation("Sixel renderer initialized: {Width}x{Height}", context.Width, context.Height);
    ...
    public void Render(GameState state)
    {
        ...
        _buffer.Append(CultureInfo.InvariantCulture, $"Mode: Sixel  Size: {_context.Width}x{_context.Height}");
    ...
    public void Shutdown()
    {
        ...
        _logger.LogInformation("Sixel renderer shutting down");
