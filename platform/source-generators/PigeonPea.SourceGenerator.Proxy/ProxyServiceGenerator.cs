...
namespace PigeonPea.SourceGenerator.Proxy;
...
{
    private const string RealizeServiceAttributeName = "PigeonPea.Platform.Contracts.Core.Attributes.RealizeServiceAttribute";
    private const string SelectionStrategyAttributeName = "PigeonPea.Platform.Contracts.Core.Attributes.SelectionStrategyAttribute";
        ...
        string? selectionMode)
    {
        ...
        {
            "One" => $"_registry.Get<{serviceType.ToDisplayString()}>(PigeonPea.Platform.Contracts.Core.SelectionMode.One)",
            "HighestPriority" => $"_registry.Get<{serviceType.ToDisplayString()}>(PigeonPea.Platform.Contracts.Core.SelectionMode.HighestPriority)",
